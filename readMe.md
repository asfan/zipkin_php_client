...
zipkin下载地址：  
[https://github.com/twitter/zipkin/releases](https://github.com/twitter/zipkin/releases)或者[https://github.com/twitter/zipkin](https://github.com/twitter/zipkin)<br />这里的zipkin php scribe主要功能是在php页面中埋点，然后收集发送给collector;
...
-----------------------------------
###埋点
修改文件：/include/zipkin/phpClient/Trace.php  
...
修改文件：include/zipkin/phpClient/mq2collector.php)
...
查看MQ ，在linux shell下使用ipc查看命令：ipcs<br/>
